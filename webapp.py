...
#https://www.perplexity.ai/search/can-you-fix-the-tabs-in-this-i-MCMslKKOSpKb6Z2xJADivw
...
# Quiz questions - FIXED keys consistency
quiz = {
    1: {
...
def question(qnum):
    ...
    # Handle POST - FIXED INDENTATION
    if request.method == 'POST':
        selected = request.form.get('answer')
        print(f"SAVING Q{qnum}: {selected}")  # Debug
...
def results():
    ...
    for qnum, qdata in quiz.items():
        ...
        detailed_results.append({
            ...
            "correct_answer": "Any" if is_any else qdata['answer'],
            "correct": correct,
